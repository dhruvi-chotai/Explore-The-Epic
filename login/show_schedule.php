...
for($i = 1; $i < $_SESSION['index']; $i++){
  ...
  $message.=$gmap.' ';
	$_SESSION['ival'] = $_SESSION['ival'] + 1;
		...
		$mail->Username = 'exploretheepic@gmail.com';					//Sets SMTP username
		$mail->Password = 'dhruvicharusat206@';					//Sets SMTP password
		$mail->SMTPSecure = 'tls';							//Sets connection prefix. Options are "", "ssl" or "tls"
		$mail->From ="exploretheepic@gmail.com";					//Sets the From email address for the message
...
<!DOCTYPE html>
		...
		<link rel="stylesheet" type="text/css" href="css/show_schedule.css">
		<!--===============================================================================================-->
		...
		<!-- Header -->
		<div class="header">
			<a href="home.php" class="logo"><img src="images/logo.png" alt="explore the epic"></a>
...
//calculates distance between two points in km's
	...
	//		btn.setAttribute("class","btnsize");
          ...
          <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBXe-dr8rqHPjfM-8g80o0Q3yETdUCeVCE&callback=initMap&libraries=geometry">
            </script>
